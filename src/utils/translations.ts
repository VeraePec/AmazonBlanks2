...
export const TRANSLATIONS = {
  ...
  no: { // Norwegian
    ...
    'reviews.detailed.great.value': 'Utmerket verdi for pengene! Dette produktet leverer på alle nivåer. Kvaliteten er overraskende god for prisen, og det fungerer akkurat som beskrevet. Jeg har brukt det i en måned og det holder seg bra. Designet er praktisk og brukervennlig. Instruksjonene var enkle å følge og monteringen var rask. Selv om det ikke er det dyreste alternativet, føles det solid og godt laget. Det er definitivt et produkt jeg ville anbefalt til andre. God kvalitet til en rimelig pris.',
    'reviews.detailed.reliable.quality': 'Meget fornøyd med dette produktet. Det er bygget med god kvalitet og føles solid. Jeg har brukt det i flere uker og det fungerer konsistent. Designet er praktisk og funksjonelt. Instruksjonene var tydelige og monteringen var enkel. Materialene bruker god kvalitet og det ser ut til å være laget for å vare. Det er et produkt jeg kan stole på og ville definitivt kjøpt igjen. Anbefaler det til andre som leter etter noe pålitelig.',
    'reviews.detailed.solid.construction': 'Solid konstruksjon og god kvalitet. Dette produktet er godt laget og føles robust. Jeg har brukt det i en måned og det holder seg bra. Designet er funksjonelt og brukervennlig. Instruksjonene var klare og monteringen tok ikke lang tid. Materialene bruker høy kvalitet og det ser ut til å være bygget for å vare. Det er verdt investeringen og jeg ville anbefalt det til andre. God verdi for pengene.',
